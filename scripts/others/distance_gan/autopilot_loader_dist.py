...
def autopilot_model_loader(img_size):
	...
	if img_size == 128:
		...
		checkpoint = torch.load('/home/harshitha/Autopilot_pytorch/python2_codes/128/pytorch_0_12/model_autopilot_no_test_epoch_20.ckpt', map_location=lambda storage, location: storage)
