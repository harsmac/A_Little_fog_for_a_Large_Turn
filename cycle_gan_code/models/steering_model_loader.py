...
def autopilot_model_loader():
	...
	checkpoint = torch.load('../../steering_models/AutoPilot/model_autopilot_no_test_epoch_390.ckpt', map_location=lambda storage, location: storage)
...
def comma_ai_model_loader():
	...
	checkpoint = torch.load('../../steering_models/Comma_ai/model_comma_ai_no_test_epoch_460.ckpt', map_location=lambda storage, location: storage)
	N_model.load_state_dict(checkpoint)
